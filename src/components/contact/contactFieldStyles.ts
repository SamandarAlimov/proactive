...
export const contactInputClass =
  'min-w-0 w-full bg-transparent text-[11px] font-medium leading-5 text-foreground outline-none placeholder:text-muted-foreground/60 sm:text-[12px]';

export const contactHelperTextClass =
  'mt-2 px-1 text-[11px] leading-4.5 text-muted-foreground/90';

export const contactSelectClass = `${contactFieldShellClass} ${contactFieldFocusClass} h-[64px] w-full appearance-none px-4 text-[13px] font-medium text-foreground outline-none`;

export const contactTextInputClass = `${contactFieldShellClass} ${contactFieldFocusClass} h-[64px] w-full px-4 text-[13px] font-medium text-foreground outline-none`;
