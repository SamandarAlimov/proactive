...
const NewsPage = () => {
  ...
  const displayNews: DisplayNewsItem[] = newsData.length > 0 ? newsData.map((n) => ({
    id: n.id, date: n.created_at.slice(0, 10),
    title: lang === 'uz' ? n.title_uz : lang === 'ru' ? n.title_ru : n.title_en,
    excerpt: (lang === 'uz' ? n.excerpt_uz : lang === 'ru' ? n.excerpt_ru : n.excerpt_en) ?? '',
    image: n.image_url,
  })) : [
    { id: 'demo-1', date: '2026-03-25', title: lang === 'uz' ? "MARF brendi bilan hamkorlik" : lang === 'ru' ? "Партнёрство с MARF" : "Partnership with MARF", excerpt: lang === 'uz' ? "MARF brendi uchun to'liq brending va marketing strategiyasini muvaffaqiyatli yakunladik." : lang === 'ru' ? "Успешно завершили стратегию брендинга для MARF." : "Successfully completed branding strategy for MARF.", image: null },
    { id: 'demo-2', date: '2026-03-15', title: lang === 'uz' ? "Proactive Academy ochildi" : lang === 'ru' ? "Открытие Proactive Academy" : "Proactive Academy launched", excerpt: lang === 'uz' ? "Marketing sohasida onlayn stajirovka dasturimiz ishga tushdi." : lang === 'ru' ? "Запущена программа онлайн-стажировки." : "Our online internship program has launched.", image: null },
    { id: 'demo-3', date: '2026-02-28', title: lang === 'uz' ? "MIS loyihasi yakunlandi" : lang === 'ru' ? "Проект MIS завершён" : "MIS project completed", excerpt: lang === 'uz' ? "Milestone International School uchun marketing strategiyasi ishlab chiqildi." : lang === 'ru' ? "Разработана маркетинговая стратегия для MIS." : "Marketing strategy developed for MIS.", image: null },
  ];
