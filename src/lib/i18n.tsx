...
const translations = {
  uz: {
    ...
    events: {
      title: "Tadbirlar",
      subtitle: "Cubic Podcast",
      description: "Cubic Podcast orqali marketing, biznes va boshqaruv haqidagi suhbatlarni shu sahifada tomosha qiling.",
  ...
  en: {
    ...
    events: {
      title: "Events",
      subtitle: "Cubic Podcast",
      description: "Watch Cubic Podcast conversations about marketing, business, and management from this page.",
  ...
  ru: {
    ...
    events: {
      title: "События",
      subtitle: "Cubic Podcast",
      description: "Смотрите выпуски Cubic Podcast о маркетинге, бизнесе и управлении на этой странице.",
